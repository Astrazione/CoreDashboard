        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    study_direction_id = table.Column<int>(type: "integer", nullable: false),
                    study_group_id = table.Column<int>(type: "integer", nullable: false),
                    total_score = table.Column<decimal>(type: "numeric(7,2)", precision: 7, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    uploaded_db_record_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    theme_score = table.Column<decimal>(type: "numeric(7,2)", precision: 7, scale: 2, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@utmn.ru", "Default admin", "E56A7E1B9F08E6158E6977CD72A6AD297F681ABB6D1BF3B0573CDED5BDEAC611", 1 });
