...
namespace PredictGrades
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var splitData = mlContext.Data.TrainTestSplit(dataView, testFraction: 0.4);
            ...
            var pipeline = mlContext.Transforms
                ...
                .Append(mlContext.Transforms.Concatenate("Features", "Professor", "ScoresSum"))
            ...
            Console.WriteLine(studentDataList.Count);
